...
```bash
INIT=$(node "C:/Users/Matteo/Desktop/TS/elden-ring/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Matteo/Desktop/TS/elden-ring/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \

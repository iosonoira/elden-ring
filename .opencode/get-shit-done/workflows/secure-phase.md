...
```
Task(
  prompt="Read C:/Users/Matteo/Desktop/TS/elden-ring/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Matteo/Desktop/TS/elden-ring/.opencode/get-shit-done/templates/SECURITY.md`
